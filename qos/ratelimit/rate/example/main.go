...
import (
	...
	rateproxy "github.com/starvn/sonic/qos/ratelimit/rate/proxy"
	raterouter "github.com/starvn/sonic/qos/ratelimit/rate/router/gin"
...
func main() {
	...
	configFile := flag.String("c", "qos/ratelimit/rate/example/sonic.json", "Path to the configuration filename")
	flag.Parse()
