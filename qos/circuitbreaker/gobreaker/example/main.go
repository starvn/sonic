...
import (
	...
	cel "github.com/starvn/sonic/validation/explang"
...
func main() {
	...
	configFile := flag.String("c", "qos/circuitbreaker/gobreaker/example/sonic.json", "Path to the configuration filename")
	flag.Parse()
