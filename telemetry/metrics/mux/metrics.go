...
func NewHTTPHandler(name string, h http.Handler, rm *metrics2.RouterMetrics) http.HandlerFunc {
...
func newHTTPResponseWriter(name string, rw http.ResponseWriter, rm *metrics2.RouterMetrics) *responseWriter {
