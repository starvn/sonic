...
func TestDisabledRouterMetrics(t *testing.T) {
	...
	cfg := map[string]interface{}{metrics2.Namespace: map[string]interface{}{"router_disabled": true}}
...
func TestNew(t *testing.T) {
	...
	buf := bytes.NewBuffer(make([]byte, 1024))
	l, _ := log.NewLogger("DEBUG", buf, "")
	metricsCfg := map[string]interface{}{metrics2.Namespace: map[string]interface{}{"collection_time": "1s"}}
...
func TestNewHTTPHandler(t *testing.T) {
	...
	rm := metrics2.NewRouterMetrics(&registry)
...
func TestStatsEndpoint(t *testing.T) {
	...
	buf := bytes.NewBuffer(make([]byte, 1024))
	l, _ := log.NewLogger("DEBUG", buf, "")
	cfg := map[string]interface{}{metrics2.Namespace: map[string]interface{}{"collection_time": "100ms", "listen_address": ":8999"}}
	_ = New(ctx, cfg, l)
