...
import (
	...
	"github.com/starvn/sonic/endpoint/martian"
	"github.com/starvn/sonic/logging/gologging"
...
func main() {
	...
	configFile := flag.String("c", "endpoint/martian/example/static/health.json", "Path to the configuration filename")
	flag.Parse()
