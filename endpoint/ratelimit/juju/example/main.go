...
import (
	...
	jujuproxy "github.com/starvn/sonic/endpoint/ratelimit/juju/proxy"
	jujurouter "github.com/starvn/sonic/endpoint/ratelimit/juju/router/gin"
...
func main() {
	...
	configFile := flag.String("c", "endpoint/ratelimit/juju/example/sonic.json", "Path to the configuration filename")
	flag.Parse()
