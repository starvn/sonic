...
import (
	...
	rateproxy "github.com/starvn/sonic/ratelimit/rate/proxy"
	raterouter "github.com/starvn/sonic/ratelimit/rate/router/gin"
...
func main() {
	...
	configFile := flag.String("c", "ratelimit/rate/example/sonic.json", "Path to the configuration filename")
	flag.Parse()
