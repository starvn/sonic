...
import (
	...
	metricsgin "github.com/starvn/sonic/monitoring/metrics/gin"
	metricsmux "github.com/starvn/sonic/monitoring/metrics/mux"
...
func main() {
	...
	configFile := flag.String("c", "monitoring/metrics/example/sonic.json", "Path to the configuration filename")
	flag.Parse()
